...
import FurnitureModelProductCreateUseCase from "./product/furniture-product-create-use-case";
import FurnitureModelsFetchUseCase from "./product/furniture-fetch-use-case";
...
export const initializeDIContainer = () => {
    ...
    DIContainer.bind(FurnitureModelProductCreateUseCase)
        .toSelf()
        .inSingletonScope();
