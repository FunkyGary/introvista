...
export const furnitureProductSchema = z.object({
    furnitureName: z.string().min(1, "Name is required"),
    furnitureCategory: z.string().min(1, "Category is required"),
...
export const materialProductSchema = z.object({
    ...
    materialCategory: z.string().min(1, "materialCategory is required"),
    category: z.string().min(1, "Category is required"),
...
export type FurnitureProductCreateDto = z.infer<typeof furnitureProductSchema>;
